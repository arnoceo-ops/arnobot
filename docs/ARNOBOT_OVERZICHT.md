...
Een live oefengesprek tegen een AI-tegenstander: een lastige prospect, een sceptische CFO, of een aangepaste rol. Geen adviezen lezen, maar daadwerkelijk oefenen onder druk. De tegenstander kan het gesprek ook zelf afronden (akkoord, hard nee, of het loopt dood), net als een echte koper. Na afloop volgt een debrief met analyse van het gesprek. Beschikbaar op alle betaalde tiers, ook Basic. **Uitzondering (sinds 22 augustus 2026):** een bevestigde teambaas heeft zelf geen toegang tot sparring, oefenen voor eigen verkoopgesprekken is niet relevant voor wie zelf niet meer verkoopt (zie 3.7).
...
- **1:1 Meetings-overzicht (22 augustus 2026):** teambreed totaal 1:1's in de laatste 30 dagen, dekking (hoeveel teamleden hadden in de afgelopen 7 dagen minstens één 1:1) en het aantal openstaande 1:1-acties (nog geen terugkoppeling), zodat in één oogopslag zichtbaar is wie gemist wordt en wat er nog moet gebeuren
...
Een statuskader onder de hero op de hoofdpagina (alleen desktop/laptop, niet in de mobiele app), zichtbaar vanaf 5 gesprekken totaal. Toont de vier tellers (gesprekken, sparsessies, analyses, coachings) en wijst naar de bouwsteen die op dit moment het meest waardevol zou zijn om te proberen: sparren, analyseren of coachen. De aanbeveling is rolbewust: een leidinggevende rol krijgt structureel minder snel een sparadvies dan een verkoper die zelf klantgesprekken voert. Bepaald door een AI-classificatie die na elk afgesloten gesprek en na elke afgeronde sparsessie opnieuw meekijkt (profiel, wat er net gebeurd is, huidige tellers), niet door een simpele "laagste getal wint"-rekensom. Bij een al goede, rolpassende balans blijft het kader gewoon weg. Bij coaching als aanbeveling krijgen Basic-gebruikers een upgradeknop naar Pro in plaats van een directe link, coaching zelf is Basic niet beschikbaar (zie 3.3).
