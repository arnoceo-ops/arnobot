...
- **ArnoBot-weergave, inhoud (herzien 2026-08-14):** toont drie getallen, voor de gemarkeerde maand en cumulatief over 5 jaar: de totale omzet in het scenario (eigen klanten van de agent plus de gedeelde pool), wat daarvan aan de agent wordt uitgekeerd (haar eigen commissie plus haar aandeel uit de pool, exact hetzelfde bedrag als de agent zelf op de andere toggle ziet), en wat ArnoBot zelf overhoudt (het verschil). Bewust géén dubbeling van de invoervelden of de detailtegels (churn, instroom, pool-uitsplitsing) die al op de Sales Agent-weergave staan, dat is één toggle verderop al zichtbaar. Verving een eerdere, smallere versie die alleen het bedrijfsdeel over de eigen klanten van de agent toonde (de 60%/80%-tegenhanger van hun commissie), zonder de gedeelde pool mee te nemen.
