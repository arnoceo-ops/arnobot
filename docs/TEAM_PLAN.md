...
**Eerstvolgende stap:** 2A (De Spiegel) bouwen. Nog niet gestart.
...
| 2A | De Spiegel (thema-labels per sessie, teambrede patroonherkenning) | **Eerstvolgende stap.** Onafhankelijk van 5/6/1, versterkt 5 direct |
