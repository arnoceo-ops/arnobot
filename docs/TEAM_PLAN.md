...
**Eerstvolgende stap:** pijlerdefinities zijn bevestigd (zie sectie "Punt 5 — ontwerp" hieronder), bouw van punt 5 (route, synthese-prompt, DB-wiring, UI) kan beginnen. 2A verder los daarvan verifiëren zodra er echte teamdata is (drempel 30 sessies teambreed nog niet gehaald bij Thijs' team, dus visueel nog niet te testen).
