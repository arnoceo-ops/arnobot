...
**Eerstvolgende stap:** punt 5 is klaar. Door naar **punt 4** (actieve sturing/handvatten, contentlaag bovenop 5). 2A verder los daarvan verifiëren zodra er echte teamdata is (drempel 30 sessies teambreed nog niet gehaald bij Thijs' team, dus visueel nog niet te testen).
