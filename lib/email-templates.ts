  ...
  switch (type) {
    ...
    case 'referral_aanmelding': {
      ...
      return {
        ...
        html: mail(
          `<strong style="color:#f1f5f9;">${newUser}</strong> heeft zich zojuist aangemeld via jouw referral link.<br><br>Zodra ${newUser} een betaald abonnement afsluit, ontvang jij €77 tegoed. Bij een maandabonnement na drie voltooide betaalmaanden. Bij een jaarabonnement direct na de eerste betaling.`,
