      ...
      <div style={{ maxWidth: 812, margin: '0 auto', padding: 'clamp(80px,12vw,120px) clamp(16px,4vw,20px) 80px' }}>
        ...
        {sent ? (
          ...
          <form onSubmit={submit}>
            ...
            <Block nr="06" title="Wat vind je van de tariefstelling?" sub="€77 P/M · 3 MAANDEN GRATIS: €697 P/J · PER GEBRUIKER">
              ...
              {aanbevelen === 'Ja' && (
                <div style={{ background: '#1f2937', borderLeft: '3px solid #f59e0b', padding: '16px 20px' }}>
                  <p style={{ fontSize: 15, lineHeight: 1.9, color: '#9ca3af' }}>
                    Gebruik dan de referral code op de accountpagina. Per betalende referral ontvang je €77 tegoed, automatisch verrekend op je volgende factuur.
                  </p>
                </div>
              )}
