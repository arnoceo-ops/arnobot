...
const INVENTORY = [
  ...
  { route: 'app/api/canvas/alignment/route.ts (samenvatting)', model: 'claude-sonnet-4-6', reden: 'Kort prompt, retry+fallback toegevoegd' },
  { route: 'app/api/canvas/alignment/route.ts (vraaganalyse)', model: 'claude-sonnet-4-6', reden: 'JSON-fallback aanwezig' },
  { route: 'app/api/canvas/alignment-chat/route.ts', model: 'claude-sonnet-4-6', reden: 'Fallback-tekst aanwezig' },
  { route: 'app/api/arnobot/route.ts (feedback-modus)', model: 'claude-sonnet-4-6', reden: 'Retry+fallback toegevoegd' },
  { route: 'app/api/arnobot/route.ts (score-modus)', model: 'claude-sonnet-4-6', reden: 'JSON.parse vangt leeg antwoord impliciet op' },
