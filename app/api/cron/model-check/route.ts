...
const INVENTORY = [
  { route: 'app/api/chat/route.ts (hoofdchat)', model: 'claude-sonnet-4-6', reden: 'Sonnet 5 teruggedraaid: geen text block bij thinking mode op lange vragen' },
  ...
  { route: 'app/api/bot/uitdaging/route.ts', model: 'claude-fable-5', reden: 'Grammaticale kwaliteit en voortgangsherkenning vereisen Fable' },
  ...
  { route: 'app/api/bot/coaching-precheck/route.ts', model: 'claude-sonnet-5', reden: 'Losse ja/nee-check, expliciete fallback' },
  { route: 'app/api/bot/verfijn/route.ts', model: 'claude-sonnet-5', reden: 'Herschrijft gebruikersvraag, expliciete fallback' },
  { route: 'app/api/bot/search-linkedin-profile/route.ts', model: 'claude-sonnet-5', reden: 'Opzoektaak met web_search tool' },
  ...
  { route: 'app/api/canvas/alignment/route.ts (samenvatting)', model: 'claude-sonnet-5', reden: 'Kort prompt, nog geen leeg-check' },
  { route: 'app/api/canvas/alignment/route.ts (vraaganalyse)', model: 'claude-sonnet-5', reden: 'JSON-fallback aanwezig' },
  { route: 'app/api/canvas/alignment-chat/route.ts', model: 'claude-sonnet-5', reden: 'Fallback-tekst aanwezig' },
  { route: 'app/api/arnobot/route.ts (feedback-modus)', model: 'claude-sonnet-5', reden: 'Kort prompt, nog geen leeg-check' },
  { route: 'app/api/arnobot/route.ts (score-modus)', model: 'claude-sonnet-5', reden: 'JSON.parse vangt leeg antwoord impliciet op' },
  { route: 'app/api/cron/refresh-openers/route.ts', model: 'claude-sonnet-5', reden: 'Expliciete JSON-structuurcheck aanwezig' },
  ...
  { route: 'app/api/admin/blogs-analyse/route.ts', model: 'claude-sonnet-4-6', reden: 'Al op een stabiel model' },
  { route: 'app/api/admin/meta-analyse/route.ts', model: 'claude-sonnet-4-6', reden: 'Al op een stabiel model' },
  { route: 'app/api/cron/meta-analyse/route.ts', model: 'claude-sonnet-4-6', reden: 'Al op een stabiel model' },
