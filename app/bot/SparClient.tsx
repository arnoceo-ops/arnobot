      ...
      <div className="spar-page" style={started ? { paddingBottom: isMobile ? 280 : 240 } : {}}>
        ...
        {!started && !loading && mode === 'voorbeeldvragen' && (
          <div className="spar-openers" style={isSalesOnlyProfiel ? { paddingTop: 20 } : undefined}>
              ...
              <>
                ...
                {isMobile ? (
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 8, width: '100%', maxWidth: 180, margin: '0 auto' }}>
                    ...
                    <button className={`toggle-btn${openerModus === 'organisatorisch' ? ' active' : ''}`} onClick={() => setOpenerModus('organisatorisch')}>PEOPLE</button>
                    <button className={`toggle-btn${openerModus === 'sales' ? ' active' : ''}`} onClick={() => setOpenerModus('sales')}>EXECUTION</button>
                  </div>
                ) : (
            ...
            <span className="spar-questions-label">{isSalesOnlyProfiel ? 'selecteer een van de onderstaande vragen' : 'en selecteer een van de onderstaande vragen'}</span>
