...
export default function DownloadPdfButton({
  ...
  return (
    <button
      ...
      disabled={loading}
      style={{ background: loading ? '#374151' : '#f59e0b', color: '#111827', border: 'none', borderRadius: 999, padding: '10px 20px', fontWeight: 700, cursor: loading ? 'not-allowed' : 'pointer', fontSize: '12px', letterSpacing: '1px' }}
    >
