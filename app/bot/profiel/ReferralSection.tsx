  ...
  return (
    <div style={wrapStyle}>
      ...
      <p style={{ fontFamily: "'Space Mono', monospace", fontSize: 15, lineHeight: 1.9, color: '#9ca3af', marginBottom: 24 }}>
        Deel deze link. Nieuwe gebruikers krijgen de eerste maand gratis. Jij ook: per betalende referral ontvang jij één maand gratis (€77 tegoed). Bij 25 betalende referrals word je lid van de ArnoBot Ambassadors Club. Bij 50 betalende referrals krijg je een Lifetime Subscription op ArnoBot. Bij 100 betalende referrals krijg je een aanbieding voor deelname in de ArnoBot Venture. Go, Go Gadget 🚀
      </p>
