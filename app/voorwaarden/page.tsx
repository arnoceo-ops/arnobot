          ...
          {[
            ...
            },
            {
              ...
              content: [
                ...
                <p key="b" style={{ fontSize: 15, color: '#9ca3af', lineHeight: 1.9, marginBottom: 12 }}>Voor maandelijks abonnement bedraagt de opzegtermijn één kalendermaand. Opzegging dient te worden ingediend vóór de eerste dag van de volgende kalendermaand en gaat in op de eerste dag van de maand daarna. De Gebruiker is over die tussenliggende maand de volledige abonnementsprijs verschuldigd. Voorbeeld: opzegging op enig moment in juni betekent dat juli volledig verschuldigd is en het abonnement eindigt op 1 augustus.</p>,
